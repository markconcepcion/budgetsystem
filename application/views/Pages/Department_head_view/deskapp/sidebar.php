	...
	<div class="menu-block customscroll" id="sidebar">
		...
		<div class="sidebar-menu" id="sidebar">
			<ul id="accordion-menu">
				<li>
					<a href="<?php echo base_url('Department_head/Home'); ?>" class="dropdown-toggle no-arrow">
						<i class="icon-copy fa fa-home" aria-hidden="true"></i>
						<span>HOME</span>
					</a>
				</li>						
				<li>
					<a href="<?php echo base_url('Department_head/Lbp'); ?>" class="dropdown-toggle no-arrow">
						<i class="fa fa-list" aria-hidden="true"></i>
						<span>SUBMIT LBP</span>
					</a>
				</li>
				<li>
					<a href="<?php echo base_url('Department_head/Obligation_request'); ?>" class="dropdown-toggle no-arrow">
						<i class="fa fa-paperclip" aria-hidden="true"></i>
						<span>SUBMIT OBR</span>
					</a>
				</li>
				<li>
					<a href="<?php echo base_url('Department_head/Notebook'); ?>" class="dropdown-toggle no-arrow">
