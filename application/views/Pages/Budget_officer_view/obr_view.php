        ...
        <div class="min-height-200px">
            <div class="pd-20 bg-white border-radius-4 box-shadow mb-30 primaryscroll">
                <div class="text-right" style="width: 99.8%;">
                    <?php if ($order === "DESC") { ?>
                        <a href="<?php echo base_url('BO/VIEW_OBR/'.date('Y').'/'.'ASC'); ?>"><button class="btn btn-warning">
                            <i class="icon-copy fa fa-sort-amount-asc" aria-hidden="true"></i>
                            SORT ASCENDINGLY
                        </button></a>
                    <?php } else { ?>
                        <a href="<?php echo base_url('BO/VIEW_OBR/'.date('Y').'/'.'DESC'); ?>"><button class="btn btn-warning">
                            <i class="icon-copy fa fa-sort-amount-asc" aria-hidden="true"></i>
                            SORT DESCENDINGLY
                        </button></a>
                    <?php }?>
                    ...
                    <tbody>
                        <?php $i=0; foreach ($obrs as $obr) {  
                            ...
                            <tr><td><?php echo $i; ?></td>
                                ...
                                <td><?php if ($obr['obr_tempRemark'] != null) {
                                        echo "RETURNED";
                                    } else { echo $obr['OBR_STATUS']; } ?>
                                </td>
