            ...
            <div class="pd-20 bg-white border-radius-4 box-shadow mb-30 primaryscroll">
                <?php echo form_open('Superuser/Assignation/changeAssign'); ?>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12 col-md-6">
                            <input class="form-control" id="mayor-input" type="text" name="newAssign" value="<?php echo $mayor['assign_name']; ?>" readonly="">
                            <input type="text" name="post" value="MAYOR" hidden="">
                        </div>
                ...
                <?php echo form_open('Superuser/Assignation/changeAssign'); ?>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12 col-md-6">
                            <input class="form-control" id="bhead-input" type="text" name="newAssign" value="<?php echo $bhead['assign_name']; ?>" readonly="">
                            <input type="text" name="post" value="BUDGET HEAD" hidden="">
                        </div>
