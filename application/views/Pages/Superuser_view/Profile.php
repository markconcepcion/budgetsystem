    ...
    <div class="pd-ltr-20 customscroll customscroll-10-p height-100-p xs-pd-20-10">
        <div class="min-height-200px">
            <div class="pd-20 bg-white border-radius-4 box-shadow mb-30 primaryscroll">
                ...
                <?php echo form_open('Superuser/Profile/editProfile/'.$this->session->userdata('id')); ?>
                    <div class="form-group row">
                        <label class="col-sm-12 col-md-2 col-form-label">First Name</label>
                        <div class="col-sm-12 col-md-10">
                            <input class="form-control editable" type="text" name="fname" value="<?php echo $uprofile['USR_FNAME']; ?>" readonly="" required="">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-12 col-md-2 col-form-label">Middle Name</label>
                        <div class="col-sm-12 col-md-10">
                            <input class="form-control editable" type="text" name="mname" value="<?php echo $uprofile['USR_MNAME']; ?>" readonly="" required="">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-12 col-md-2 col-form-label">Last Name</label>
                        <div class="col-sm-12 col-md-10">
                            <input class="form-control editable" type="text" name="lname" value="<?php echo $uprofile['USR_LNAME']; ?>" readonly="" required="">
                        </div>
                    </div>
                    <div class="form-group row">
