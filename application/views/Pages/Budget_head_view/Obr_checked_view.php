<?php 
    ...
    $remain_bal = $total_allot-$total_release;
                    ...
                    <div class="col-sm-12 col-md-7 box-shadow" style="padding:15px;">
                        <div class="form-group row" style="margin-bottom:0;">
                            ...
                            <div class="col-md-6 col-sm-12">
                                <input name="mbo_no" class="line-input" value="<?php echo $obr_details['MBO_ID']; ?>">
                            </div>
                        </div>
                        <div class="form-group row" style="margin-bottom:0;">
                            <label class="col-md-3 col-sm-12 label-input">Exp. Class&nbsp;</label>
                            <div class="col-md-9 col-sm-12">
                                <input id="exp-mbo" class="line-input" value="<?php echo $obr_details['EXP_NAME']; ?>">
                            </div>
                        </div>
                        <div class="form-group row" style="margin-bottom:0;">
                            <label class="col-md-3 col-sm-12 label-input">Amt. Approp.</label>
                            <div class="col-md-5 col-sm-12">
                                <input type="text" class="line-input" id="mbo-amt-approp" value="<?php echo '₱'.number_format($lbp_exp['LBP_EXP_AMOUNT'],2); ?>" readonly>
                            </div>
                        ...
                        <div class="form-group row" style="margin-bottom:0;">
                            ...
                            <div class="col-md-9 col-sm-12">
                                <input type="text" class="line-input" id="mbo-prev-allot" value="<?php echo '₱'.number_format($prev_allot,2); ?>" readonly>
                            </div>
                        </div>
                        <div class="form-group row" style="margin-bottom:0;">
                            <label class="col-md-3 col-sm-12 label-input">Qtr. Allot.</label>
                            <div class="col-md-4 col-sm-12">
                                <input type="text" class="line-input" id="mbo-qtr-allot" value="<?php echo '₱'.number_format($qtr_allot,2); ?>" readonly>
                            </div>
                            <div class="col-md-5 col-sm-12">
                                <input type="text" class="line-input"  id="mbo-total-allot" value="<?php echo '₱'.number_format($total_allot,2); ?>" readonly>
                            </div>
                        </div>
                        ...
                        <div class="form-group row" style="margin-bottom:0;">
                            ...
                            <div class="col-md-5 col-sm-12">
                                <input type="text" class="line-input" id = "mbo-rem-bal" value="<?php echo '₱'.number_format($remain_bal,2); ?>" readonly>
                            </div>
                        </div>
                        ...
                        <div class="form-group row" style="margin-bottom:0;">
                            ...
                            <div class="col-md-5 col-sm-12">
                                <input type="text" id="mbo-ltc" class="line-input" value="<?php echo '₱'.number_format($obr_details['PART_AMOUNT'],2); ?>" readonly>
                            </div>
                        </div>
                        ...
                        <div class="form-group row" style="margin-bottom:0;">
                            ...
                            <div class="col-md-5 col-sm-12">
                                <input type="text" class="line-input" id = "mbo-bal-approp" value="<?php echo '₱'.number_format($bal_approp,2); ?>" readonly>
                            </div>
                        </div>
                        ...
                        <div class="form-group row" style="margin-bottom:0;">
                            ...
                            <div class="col-md-4 col-sm-12">
                                <input type="text" class="line-input" name="initial" value="<?php echo $obr_details['MBO_INITIAL']; ?>">
                            </div>
