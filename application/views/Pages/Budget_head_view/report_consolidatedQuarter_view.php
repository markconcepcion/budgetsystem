        ...
        <tbody>
            <?php foreach ($exp_classes as $exc) { ?>
                ...
                <?php foreach ($exps as $exp) { 
                    if ($exc['EXPCLASS_ID'] === $exp['EXPENDITURE_CLASS_EXPCLASS_ID']) { ?>
                        <tr>
                            ...
                            <?php $ab=0;
                                foreach ($lbps_exps as $lbp_exp) {  $ab+=$lbp_exp['LBP_EXP_AMOUNT'];
                            ...
                            <?php foreach ($lbps_exps as $lbp_exp) { 
                                if ($lbp_exp['EXPENDITURE_EXPENDITURE_id'] === $exp['EXPENDITURE_id']) { ?>
                                    <td class="text-left"><?php echo '₱ '.number_format($lbp_exp['LBP_EXP_AMOUNT'],2); ?></td>
                                <?php } 
                            } ?>
                            ...
                            <?php 
                                foreach ($quarter_obr as $obr) { if ($obr['EXPENDITURE_id'] === $exp['EXPENDITURE_id']) { ?>
                                    <td class="text-left"><?php echo '₱ '.number_format($obr['PART_AMOUNT'],2); ?></td>
                                <?php } 
                            } ?>
                ...
                <tr>
                    ...
                    <td class = "text-right sub-total"><b>0</b></td>
                    <td class = "text-right sub-total"><b>0</b></td>
                    <td class = "text-right sub-total"><b>0</td></b></td>
                    <td class = "text-right sub-total"><b>0</td></b></td>
                    <td class = "text-right sub-total"><b>0</b></td>
                    <td class = "text-right sub-total"><b>0</b></td>
                    <td class = "text-right sub-total"><b>0</b></td>
