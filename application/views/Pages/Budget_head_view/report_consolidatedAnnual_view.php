...
<div class="bar text-right toHide" style="height:auto;">
    <a href="<?php echo base_url('budget_officer/Reports'); ?>"><button class="btn btn-warning"><i class="fa fa-arrow-left" aria-hidden="true"></i>&nbsp;Back</button></a>
        ...
        <tbody>
            <?php foreach ($exp_classes as $exc) { ?>
                ...
                <tr>
                    ...
                    <td class = "text-right sub-total" id = "ps_sub"></td>
                    <td class = "text-right sub-total"><b>0</b></td>
                    <td class = "text-right sub-total"><b>0</b></td>
                    <td class = "text-right sub-total"><b>0</b></td>
                    <td class = "text-right sub-total" id = "ps_sub5"><b>0</b></td>
                    <td class = "text-right sub-total" id = "ps_sub6"><b>0</b></td>
                    <td class = "text-right sub-total"><b>0</b></td>
                    <td class = "text-right sub-total"><b>0</b></td>
                    <td class = "text-right sub-total" id = "ps_sub9"><b>0</b></td>
                    <td class = "text-right sub-total" id = "ps_sub10"><b>0</b></td>
                </tr>
            <?php } ?>
        </tbody>
    </table>
