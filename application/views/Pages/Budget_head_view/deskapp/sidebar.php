	...
	<div class="menu-block customscroll" id="sidebar">
		...
		<div class="sidebar-menu" id="sidebar">
			<ul id="accordion-menu">
				<li>
					<a href="<?php echo base_url('Budget_head/Home'); ?>" class="dropdown-toggle no-arrow <?php if($highlights === 'home') { echo 'active'; } ?>">
						<i class="icon-copy fa fa-home" aria-hidden="true"></i>
						<span class="mtext">HOME</span>
					</a>
				</li>
				<li>
					<a href="<?php echo base_url('Budget_head/Obr'); ?>" class="dropdown-toggle no-arrow <?php if($highlights === 'obr') { echo 'active'; } ?>">
						<i class="fa fa-paperclip" aria-hidden="true"></i><span class="mtext">OBR</span>
					</a>
				</li>
				<li>
					<a href="<?php echo base_url('Budget_head/Reports'); ?>" class="dropdown-toggle no-arrow <?php if($highlights === 'report') { echo 'active'; } ?>">
						<i class="fa fa-bar-chart" aria-hidden="true"></i><span class="mtext">REPORTS</span>
					</a>
				</li>
				
				<li>
					<a href="<?php echo base_url('Budget_head/Lbp'); ?>" class="dropdown-toggle no-arrow <?php if($highlights === 'lbp') { echo 'active'; } ?>">
						<i class="fa fa-list" aria-hidden="true"></i><span class="mtext">LBP</span>
					</a>
				</li>
				<li>
					<a href="<?php echo base_url('Budget_head/Logbook'); ?>" class="dropdown-toggle no-arrow <?php if($highlights === 'logbook') { echo 'active'; } ?>">
						<i class="fa fa-bookmark" aria-hidden="true"></i><span class="mtext">LOGBOOK</span>
					</a>
				</li>
				<li>
					<a href="<?php echo base_url('Budget_head/CNotebook'); ?>" class="dropdown-toggle no-arrow <?php if($highlights === 'notebook') { echo 'active'; } ?>">
