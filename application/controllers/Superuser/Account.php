<?php
    class Account extends CI_Controller
    {
        ...
        public function index()
        {
            ...
            $data['dept_list'] = $this->dept_model->readDpts();
        ...
        public function activateAcct($userID)
        {
            ...
            $checkPost = $this->user_model->checkPostVacancy($userData['DPT_ID'], $userData['role_id']);
